            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- BEGIN PAGE CONTENT -->
                        <h2>Documentation:</h2>
                        <p>For the student user, this page will provide a viewable profile for a given teacher, displaying scheduling, office hours, contact information, and active courses</p>
